            ...
            <div class="box mart">
                <div class="box2">
                    <form action="logincheck.php" method="POST">
                        ...
                        <input class="form-control mx-auto" type="nickname" size="40" id="nickname" name="nickname"
                            style="width:75%" required><br>
                        <div class="left">
                            <label class="ms-5 mb-1 left">パスワード</label><br>
                        </div>
                        <input class="form-control mx-auto" type="password" size="40" id="password" name="password"
                            style="width:75%" required><br>
                </div>
                <div class="btns">
                    <input type="button" value="　戻る　" onclick="location.href='index.php'"
                        class="btn btn_re2 btn-outline-secondary mb-3">
